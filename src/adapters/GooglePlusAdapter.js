...
module.exports = class GooglePlusAdapter extends BaseAdapter {
	...
	authenticate(req, res, next) {
		return this.getAuthMiddleware('google-oauth')(req, res, next);
	}

	authCallback(req, res, next) {
		return this.getCallbackMiddleware('google-oauth')(req, res, next);
	}
}
